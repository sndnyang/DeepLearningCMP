...
class MNIST(object):
    ...
    def __init__(self, data_dir, subset, batch_size, is_training=False):
        ...
        dataset_images = tf.data.FixedLengthRecordDataset(images_file, IMAGE_BYTES, header_bytes=16)

        dataset_labels = tf.data.FixedLengthRecordDataset(labels_file, LABEL_BYTES, header_bytes=8)
        ...
        self.dataset = dataset.prefetch(buffer_size=max(1, int(128 / batch_size)))
    ...
    def get_next(self):
        self.images, labels = self.iterator.get_next()
